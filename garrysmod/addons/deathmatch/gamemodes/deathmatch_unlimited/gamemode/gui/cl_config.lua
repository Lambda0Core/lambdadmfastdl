...
function PANEL:Init()
    ...
    reset.DoClick = function()
        starter = "weapon_pistol,weapon_crowbar,weapon_smg1"
        common = "weapon_alyx-gun,weapon_mp-5,weapon_hl1_shotgun"
        uncommon = "weapon_hl1_satchel,weapon_357,weapon_original_new"
        rare = "weapon_ar2,weapon_crossbow,weapon_oicw,weapon_hl1_snark"
        very_rare = "weapon_psp,weapon_magicstick,weapon_sword,weapon_hl1_gauss"
        self.StarterWeapons:SetValue(starter)
        self.CommonWeapons:SetValue(common)
        self.UncommonWeapons:SetValue(uncommon)
        self.RareWeapons:SetValue(rare)
