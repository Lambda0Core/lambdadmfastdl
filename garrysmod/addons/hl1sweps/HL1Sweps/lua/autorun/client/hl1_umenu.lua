...
local function HL1_SettingsPanel(DForm)
	...
	local combobox = DForm:ComboBox("Spawn loadout", "hl1_sv_loadout")
	combobox:AddChoice("0: No", 0)
	combobox:AddChoice("1: Crowbar & Pistol", 1)
	combobox:AddChoice("2: Full loadout", 2)
